...
public class bba_faculty extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bba_faculty, container, false);
        recyclerView =view.findViewById(R.id.bba);
        progressBar = view.findViewById(R.id.bba_progressBar);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        reference = FirebaseDatabase.getInstance().getReference().child("teacher").child("BBA");
