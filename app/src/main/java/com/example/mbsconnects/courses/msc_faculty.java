...
public class msc_faculty extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_msc_faculty, container, false);


        recyclerView =view.findViewById(R.id.msc_recycler);
        progressBar = view.findViewById(R.id.msc_progressBar);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        reference = FirebaseDatabase.getInstance().getReference().child("teacher").child("MSc");
