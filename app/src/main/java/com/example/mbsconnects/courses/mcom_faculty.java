...
public class mcom_faculty extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_mcom_faculty, container, false);

        recyclerView =view.findViewById(R.id.mcom_recycler);
        progressBar = view.findViewById(R.id.mcom_progressBar);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        reference = FirebaseDatabase.getInstance().getReference().child("teacher").child("MCom");
