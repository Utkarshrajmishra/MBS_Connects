...
public class bsc_faculty extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bsc_faculty, container, false);

        recyclerView = view.findViewById(R.id.bsc_recycler);
        progressBar = view.findViewById(R.id.bsc_progressBar);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setHasFixedSize(true);
        reference = FirebaseDatabase.getInstance().getReference().child("teacher").child("BSc");
